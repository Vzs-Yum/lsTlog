...
public class BasicDatePickerUICustom extends DatePickerUI {
    ...
    private BasicDatePickerUICustom.Handler handler;
    /*
     * shared listeners
     */
    ...
    private BasicDatePickerUICustom.EditorCancelAction editorCancelAction;
    ...
    private BasicDatePickerUICustom.PopupRemover popupRemover;
    ...
    public static ComponentUI createUI(JComponent c) {
        return new BasicDatePickerUICustom();
    }

    
    public void installUI(JComponent c) {
        datePicker = (JXDatePickerCustom)c;
    ...
    private DateFormat[] getCustomFormats(JFormattedTextField editor) {
        ...
        if (editor != null) {
            JFormattedTextField.AbstractFormatterFactory factory = editor.getFormatterFactory();
            if (factory != null) {
                JFormattedTextField.AbstractFormatter formatter = factory.getFormatter(editor);
...
//                if (!(formatter instanceof DatePickerFormatterUIResource))  {
    ...
    protected void installDefaults() {
        ...
        boolean zoomable = Boolean.TRUE.equals(UIManager.get("JXDatePickerCustom.forceZoomable"));
        if (zoomable) {
    ...
    protected void installKeyboardActions() {
        ...
        pickerMap.put(JXDatePickerCustom.CANCEL_KEY, createCancelAction());
        pickerMap.put(JXDatePickerCustom.COMMIT_KEY, createCommitAction());
        pickerMap.put(JXDatePickerCustom.HOME_NAVIGATE_KEY, createHomeAction(false));
        pickerMap.put(JXDatePickerCustom.HOME_COMMIT_KEY, createHomeAction(true));
        BasicDatePickerUICustom.TogglePopupAction popupAction = createTogglePopupAction();
        ...
        pickerInputMap.put(KeyStroke.getKeyStroke("ENTER"), JXDatePickerCustom.COMMIT_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("ESCAPE"), JXDatePickerCustom.CANCEL_KEY);
        // PENDING: get from LF
        pickerInputMap.put(KeyStroke.getKeyStroke("F5"), JXDatePickerCustom.HOME_COMMIT_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("shift F5"), JXDatePickerCustom.HOME_NAVIGATE_KEY);
    ...
    protected void installLinkPanelKeyboardActions() {
        ...
        map.put(JXDatePickerCustom.HOME_COMMIT_KEY, datePicker.getActionMap().get(
                JXDatePickerCustom.HOME_COMMIT_KEY));
        map.put(JXDatePickerCustom.HOME_NAVIGATE_KEY, datePicker.getActionMap().get(
                JXDatePickerCustom.HOME_NAVIGATE_KEY));
    ...
    protected void uninstallLinkPanelKeyboardActions(JComponent panel) {
        ...
        map.remove(JXDatePickerCustom.HOME_COMMIT_KEY);
        map.remove(JXDatePickerCustom.HOME_NAVIGATE_KEY);
    ...
    protected void installListeners() {
        ...
        popupRemover = new BasicDatePickerUICustom.PopupRemover();
        /*
...
//  --------------------- wiring listeners
    ...
    protected void updateEditorListeners(JFormattedTextField oldEditor) {
        ...
        editorCancelAction = new BasicDatePickerUICustom.EditorCancelAction(datePicker.getEditor());
    }
    ...
    protected JFormattedTextField createEditor() {
        JFormattedTextField f = new BasicDatePickerUICustom.DefaultEditor(
                new DatePickerFormatter.DatePickerFormatterUIResource(datePicker.getLocale()));
        f.setName("dateField");
        // this produces a fixed pref widths, looking a bit funny
        // int columns = UIManagerExt.getInt("JXDatePickerCustom.numColumns", null);
        // if (columns > 0) {
        // f.setColumns(columns);
        // }
        // that's always 0 as it comes from the resourcebundle
        // f.setColumns(UIManager.getInt("JXDatePickerCustom.numColumns"));
...
//-------------------- update methods called from listeners
    ...
    protected void updateFromEditableChanged() {
         ...
         */
        setActionEnabled(JXDatePickerCustom.HOME_COMMIT_KEY, isEditable);
        // for consistency, synch navigation as well
        setActionEnabled(JXDatePickerCustom.HOME_NAVIGATE_KEY, isEditable);
    }
            ...
            if (getCustomFormats(datePicker.getEditor()) == null) {
                datePicker.getEditor().setFormatterFactory(
                        new DefaultFormatterFactory(
                                new DatePickerFormatter.DatePickerFormatterUIResource(locale)));
            }
        }
    }
...
//---------------------- other stuff
     ...
     */
    protected BasicDatePickerUICustom.TogglePopupAction createTogglePopupAction() {
        return new BasicDatePickerUICustom.TogglePopupAction();
    }
...
//                    }
     ...
     *
     */
    private BasicDatePickerUICustom.BasicDatePickerPopup createMonthViewPopup() {
        BasicDatePickerUICustom.BasicDatePickerPopup popup = new BasicDatePickerUICustom.BasicDatePickerPopup();
...
//  ------------------ listener creation
     ...
     */
    private BasicDatePickerUICustom.Handler getHandler() {
        if (handler == null) {
            handler = new BasicDatePickerUICustom.Handler();
        }
        return handler;
    }

 ...
 */
public class BasicMonthViewUICustom extends MonthViewUI {
    ...
    private BasicMonthViewUICustom.Handler handler;
     ...
     */
    private CalendarRenderingHandlerCustom renderingHandler;
    /**
     ...
     */
    private CalendarHeaderHandlerCustom calendarHeaderHandler;


    @SuppressWarnings({"UnusedDeclaration"})
    public static ComponentUI createUI(JComponent c) {
        return new BasicMonthViewUICustom();
    }
...
//                "JXMonthView.background", "JXMonthView.foreground", "JXMonthView.font");
    ...
    protected void installKeyboardActions() {
        ...
        BasicMonthViewUICustom.KeyboardAction acceptAction = new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.ACCEPT_SELECTION);
        actionMap.put("acceptSelection", acceptAction);
        BasicMonthViewUICustom.KeyboardAction cancelAction = new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.CANCEL_SELECTION);
        actionMap.put("cancelSelection", cancelAction);

        actionMap.put("selectPreviousDay", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.SELECT_PREVIOUS_DAY));
        actionMap.put("selectNextDay", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.SELECT_NEXT_DAY));
        actionMap.put("selectDayInPreviousWeek", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.SELECT_DAY_PREVIOUS_WEEK));
        actionMap.put("selectDayInNextWeek", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.SELECT_DAY_NEXT_WEEK));

        actionMap.put("adjustSelectionPreviousDay", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.ADJUST_SELECTION_PREVIOUS_DAY));
        actionMap.put("adjustSelectionNextDay", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.ADJUST_SELECTION_NEXT_DAY));
        actionMap.put("adjustSelectionPreviousWeek", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.ADJUST_SELECTION_PREVIOUS_WEEK));
        actionMap.put("adjustSelectionNextWeek", new BasicMonthViewUICustom.KeyboardAction(BasicMonthViewUICustom.KeyboardAction.ADJUST_SELECTION_NEXT_WEEK));


        actionMap.put(JXMonthViewCustom.COMMIT_KEY, acceptAction);
        actionMap.put(JXMonthViewCustom.CANCEL_KEY, cancelAction);
...
//        inputMap.put(KeyStroke.getKeyStroke("F1"), "selectPreviousDay");
     ...
     */
    protected CalendarRenderingHandlerCustom createRenderingHandler() {
        return new BasicMonthViewUICustom.RenderingHandler();
    }

    /**
     * @param renderingHandler the renderingHandler to set
     */
    protected void setRenderingHandler(CalendarRenderingHandlerCustom renderingHandler) {
     ...
     */
    protected CalendarRenderingHandlerCustom getRenderingHandler() {
     ...
     */
    protected static class RenderingHandler extends BasicCalendarRenderingHandlerCustom {
    ...
    protected void updateLocale(boolean revalidate) {
        ...
        if (daysOfTheWeek == null) {
            ...
            String[] dateFormatSymbols = DateFormatSymbols.getInstance(locale)
                    .getShortWeekdays();
            daysOfTheWeek = new String[JXMonthViewCustom.DAYS_IN_WEEK];
    ...
    private BasicMonthViewUICustom.Handler getHandler() {
        if (handler == null) {
            handler = new BasicMonthViewUICustom.Handler();
        }
    ...
    protected Point getMonthGridPosition(Date date) {
        ...
        int diffMonths = month - firstMonth
                + ((year - firstYear) * JXMonthViewCustom.MONTHS_IN_YEAR);
...
//  
    ...
    private class Handler implements
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (monthView.getSelectionMode() == DateSelectionModel.SelectionMode.SINGLE_INTERVAL_SELECTION ||
//                    selectionMode == SelectionMode.WEEK_INTERVAL_SELECTION ||
                    monthView.getSelectionMode() == DateSelectionModel.SelectionMode.MULTIPLE_INTERVAL_SELECTION) {
                pivotDate = startDate;
            }

            monthView.getSelectionModel().setAdjusting(true);

            if (monthView.getSelectionMode() == DateSelectionModel.SelectionMode.MULTIPLE_INTERVAL_SELECTION && e.isControlDown()) {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (monthView.getSelectionMode() == DateSelectionModel.SelectionMode.SINGLE_SELECTION) {
...
//------------------------ layout
        ...
        public void layoutContainer(Container parent) {
            ...
            CalendarUtils.startOfWeek(calendar);
            for (int i = 0; i < JXMonthViewCustom.DAYS_IN_WEEK; i++) {
            ...
            int dayColumns = JXMonthViewCustom.DAYS_IN_WEEK;
            if (monthView.isShowingWeekNumber()) {
                dayColumns++;
            }
            ...
            calendarWidth = fullBoxWidth * JXMonthViewCustom.DAYS_IN_WEEK;
            if (monthView.isShowingWeekNumber()) {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if ("componentOrientation".equals(property)) {
                ...
                monthView.repaint();
            } else if (JXMonthViewCustom.SELECTION_MODEL.equals(property)) {
                ...
                monthView.repaint();
            } else if (JXMonthViewCustom.BOX_PADDING_X.equals(property)
                    || JXMonthViewCustom.BOX_PADDING_Y.equals(property)
                    || JXMonthViewCustom.TRAVERSABLE.equals(property)
                    || JXMonthViewCustom.DAYS_OF_THE_WEEK.equals(property)
...
//                LOG.info("got propertyChange:" + property);
    ...
    private class KeyboardAction extends AbstractAction {
        ...
        private boolean isIntervalMode() {
            return !(monthView.getSelectionMode() == DateSelectionModel.SelectionMode.SINGLE_SELECTION);
        }
        ...
        private void traverse(int action) {
            ...
            switch (action) {
                ...
                case SELECT_DAY_PREVIOUS_WEEK:
                    cal.add(Calendar.DAY_OF_MONTH, -JXMonthViewCustom.DAYS_IN_WEEK);
                    break;
...
//--------------------- zoomable    
     ...
     */
    protected CalendarHeaderHandlerCustom createCalendarHeaderHandler() {
//        CalendarHeaderHandlerCustom handler = getHeaderFromUIManager();
        return new BasicCalendarHeaderHandlerCustom();
    }
     ...
     */
    protected void setCalendarHeaderHandler(CalendarHeaderHandlerCustom calendarHeaderHandler) {
     ...
     */
    protected CalendarHeaderHandlerCustom getCalendarHeaderHandler() {

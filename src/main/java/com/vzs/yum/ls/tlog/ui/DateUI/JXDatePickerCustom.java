 ...
 */
@Slf4j
public class JXDatePickerCustom extends JComponent {
    static {
     ...
     * @see #getTimeZone
     */
    public JXDatePickerCustom(Date selected) {
        this(selected, null);
    }
     ...
     * @see #getTimeZone
     */
    public JXDatePickerCustom(Locale locale) {
        this(null, locale);
    }
     ...
     *
     */
    public JXDatePickerCustom(Date selection, Locale locale) {
        init();
        if (locale != null) {
            setLocale(locale);
        }
    ...
    private void init() {
        ...
        _linkPanel = new JXDatePickerCustom.TodayPanel();
    }
...
//        setUI((DatePickerUI) LookAndFeelAddons.getUI(this, DatePickerUI.class));
        setUI(new BasicDatePickerUICustom());
    ...
    public DateFormat[] getFormats() {
        ...
        JFormattedTextField.AbstractFormatterFactory factory = _dateField.getFormatterFactory();
        if (factory != null) {
            JFormattedTextField.AbstractFormatter formatter = factory.getFormatter(_dateField);
    ...
    public void setLinkDay(Date linkDay) {
        ...
        setLinkPanel(new JXDatePickerCustom.TodayPanel());
    }
...
//    @Deprecated
    ...
    private final class TodayPanel extends JXPanel {
        private JXDatePickerCustom.TodayPanel.TodayAction todayAction;
        ...
        TodayPanel() {
            ...
            todayAction = new JXDatePickerCustom.TodayPanel.TodayAction();
        ...
        private final class TodayAction extends AbstractAction {
            ...
            public void actionPerformed(ActionEvent ae) {
                String key = select ? JXDatePickerCustom.HOME_COMMIT_KEY : JXDatePickerCustom.HOME_NAVIGATE_KEY;
                select = false;
